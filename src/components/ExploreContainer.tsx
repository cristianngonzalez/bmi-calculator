import { IonGrid, IonInput, IonRow, IonCol, IonItem, IonLabel, IonAlert, } from "@ionic/react";
...
const ExploreContainer: React.FC<ContainerProps> = () => {
  ...
  const calculateBMI = () => {
    ...
    const heightConversionFactor = calcUnits === "ftlbs" ? 3.28 : 100;
          ...
          <IonCol>
            <IonItem>
              <IonLabel position="floating">
                Your Height ({calcUnits === "mkg" ? "centimeters" : "feet"})
              </IonLabel>
